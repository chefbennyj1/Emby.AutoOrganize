...
namespace Emby.AutoOrganize.Naming.Common
{
    public class NamingOptions
    {
        ...
        public string[] SubtitleLanguageExtensions { get; set; }
        ...
        public NamingOptions()
        {
            ...
            SubtitleLanguageExtensions = new[]
            {
                ".ab",
                ".aa",
                ".af",
            ...
            MultipleEpisodeExpressions = new string[]
            {
                ...
                @".*(\\|\/)(?<seriesname>[^\\\/]*)(?<seasonnumber>\d{1,4})[xX]?(?<epnumber>\d{1,3})(-[xX|[eE](?<endingepnumber>\d{1,3}))+[^\\\/]*$",
                @".*(?<seriesname>[^\\\/]*)\s(?<seasonnumber>\d{1,4})[xX\.]?(?<epnumber>\d{1,3})(-[xX]?(?<endingepnumber>\d{1,3}))"
